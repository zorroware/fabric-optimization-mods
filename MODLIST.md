...
| Item Model Fix | Removes those weird seams that appear on some minecraft items with little to no cost in performance depending on the method used. | PepperCode1 | Yes | No | None | https://github.com/PepperCode1/Item-Model-Fix
