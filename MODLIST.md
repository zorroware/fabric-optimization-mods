...
| LambdaControls | Adds improved controller support and experimental touchscreen support to java minecraft. | LambdAurora | Mostly | No | None | https://github.com/LambdAurora/LambdaControls
