...
| DashLoader | Caches all block data on the first boot and uses that cache data to load the game faster on the next boot. | alphaqu | Yes | No | None | https://github.com/alphaqu/DashLoader
