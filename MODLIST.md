...
| Ugly Scoreboard Fix | Removes the numbers at the end of the scoreboard to A. Render less and B. Look better. | Lortseam | Yes | No | None | https://gitlab.com/Lortseam/ugly-scoreboard-fix
