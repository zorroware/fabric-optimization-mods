...
| Borderless Mining | Converts fullscreen to a borderless window for improved minecraft alt tabbing on windows. | comp500 | Yes | No | None | https://github.com/comp500/BorderlessMining
