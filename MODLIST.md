...
| Fabrication | Includes a lot of bug fixes for minecraft and optionally some gameplay tweaks. | unascribed | Yes | No | None | https://github.com/unascribed/Fabrication
