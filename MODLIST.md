...
| No Fade | Removes the fade animation at the boot of the game and when reloading textures. | UltimateBoomer | Yes | No | None | https://github.com/UltimateBoomer/mc-no-fade
